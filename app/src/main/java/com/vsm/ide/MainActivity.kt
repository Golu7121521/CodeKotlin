...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appendLine("Workspace: ${StorageUtil.WORKSPACE_PATH}")
    ...
    private fun ensureStoragePermission() {
        if (!StorageUtil.hasStoragePermission()) {
            StorageUtil.requestManageAllFilesPermission(this)
            StorageUtil.requestLegacyPermissions(this, permissionRequestCode)
        }
    }
